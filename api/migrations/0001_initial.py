# -*- coding: utf-8 -*-
# Generated by Django 1.11b1 on 2017-03-22 17:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='children', to='api.Comment')),
            ],
        ),
        migrations.CreateModel(
            name='Image',
