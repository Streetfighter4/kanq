...
var TopicNewComponent = (function (_super) {
    __extends(TopicNewComponent, _super);
    function TopicNewComponent(route, postService, topicService) {
    ...
    TopicNewComponent.prototype.ngOnInit = function () {
        var _this = this;
...
exports.TopicNewComponent = TopicNewComponent;
