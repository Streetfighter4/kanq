...
var TopicTopComponent = (function (_super) {
    __extends(TopicTopComponent, _super);
    function TopicTopComponent(route, postService, topicService) {
    ...
    TopicTopComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    TopicTopComponent.prototype.loadNextPage = function (currentPage, perPage) {
        var _this = this;
        this.postService.getTop(currentPage, perPage, this.id)
            .then(function (res) { return _this.addPage(res); });
    };
    return TopicTopComponent;
}(paginated_list_component_1.PaginatedListComponent));
TopicTopComponent = __decorate([
    core_1.Component({
...
exports.TopicTopComponent = TopicTopComponent;
