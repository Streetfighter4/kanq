...
class ImageListViewTest(TestCase):
    ...
    def test_view_returns_error_with_incorrect_data(self):
        request = self.factory.post('/images/', self.error_data, format='json')
        response = self.view(request)
